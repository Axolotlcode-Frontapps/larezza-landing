...
const missionData = [
	...
	},
	{
		...
		text1:
			"* Limpia, afina poros y mejora la textura con carbón + láser suave.",
	...
	},
	{
		...
		text2: "* Reduce grasa, acné y pigmentación irregular.",
		text3:
			"* Deja la piel suave, sin irritación y apto para todo tipo de piel.",
	},
	{
		id: crypto.randomUUID(),
